...
Once you are comfortable adding pages, the next useful step is learning how to reshape category labels and routes. Continue with [Rename and Restructure Categories](/getting-started/start-here/rename-and-restructure-categories).
